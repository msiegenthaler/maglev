...
module levitator_solenoid() {
  translate([0,0,0]) rotate([0,90,0]) soleniod(len=rail_solenoid_l, outside_d=rail_solenoid_d, hole=6.1, left=true, connector=false);
  translate([0,25,0]) rotate([0,90,0]) soleniod(len=rail_solenoid_l, outside_d=rail_solenoid_d, hole=6.1, left=false, connector=false);
}
